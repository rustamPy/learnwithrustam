...
import CourseCard from '@/components/pro/CourseCard';
...
const CoursesGrid = ({ specificCourses, cardsPerPage = 4 }) => {
    ...
    return (
        <div className="flex flex-col p-6 items-center">
            <div className={`grid grid-cols-1 sm:grid-cols-4 md:grid-cols-${cardsPerPage || '4'} lg:grid-cols-${cardsPerPage || '4'} gap-6 mb-10`}>
