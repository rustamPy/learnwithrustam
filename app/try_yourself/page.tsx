...
const initialState = [
    {
        ...
        answers: ['good', 'normal', 'bad'],
        correctAnswer: ['good', 'normal'],
        level: 'medium',
        type: 'multiple',
    },
    {
        id: 1,
        question: 'Where do you optionve?',
        answers: ['Baku', 'Ganja'],
        correctAnswer: ['Baku'],
        level: 'easy',
        type: 'single'
...
const QuestionsCards: React.FC<any> = (props) => {
    ...
    return (
        <>
            <Card>
                <Card.Header className='tw-text-red'>
                    {props.level}
                </Card.Header>
                <Card.Body>
                    <Card.Title>
                    ...
                    <Form onSubmit={handleSubmit} className='p-2 m-2'>
                        ...
                        <Button className={"bg-blue-500 hover:bg-blue-400 tw-text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded"} disabled={isFirst}> Previous Question </Button>
