                ...
                <div className="text-center">
                    ...
                    >
                        <Typography className="mt-6 font-bold text-xl text-gray-800 dark:text-gray-200">
                            Master {course.title} with the comprehensive course
                        </Typography>
                    </motion.div>
                    <motion.div
                        className="mt-8"
...
function FAQSection() {
    const faqs = [
        ...
        { question: "How do I get help if I'm stuck?", answer: "We provide support through the community forum and weekly Q&A sessions." },
    ];
