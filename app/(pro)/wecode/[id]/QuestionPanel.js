            ...
            item.content && (
                <Accordion key={index} open={open === item.href} id={item.href}>
                    <AccordionHeader
                        ...
                        className="border-b-[1px] border-gray-200 dark:border-[#1e1c1cff]"
                    >
...
const QuestionPanel = ({ question, editorial }) => {
        ...
        <Panel minSize={20} defaultSize={30}>
            ...
            >
                ...
                <div className="p-4 h-full overflow-auto" ref={scrollableRef}>
                    {!question ? (
                        ...
                        <>
                            ...
                            <div
                                className="prose dark:prose-dark max-w-full leading-relaxed mb-4"
                ...
                <div className="p-4 h-full overflow-auto">
                    ...
                    {editorial?.content ? (
                        <div className="prose dark:prose-dark max-w-full" dangerouslySetInnerHTML={{ __html: editorial?.content }} />
                    ) : (
