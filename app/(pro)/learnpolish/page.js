...
import PdfViewer from '@/components/pro/PdfViewer';
        ...
        <div className="flex flex-col items-center py-8 mt-16">
            <section className="w-full max-w-6xl px-4 sm:px-6 lg:px-8 text-center">
                <div className="space-y-8">
                    ...
                    <p className="max-w-4xl mt-4 mx-auto text-xl text-gray-500 dark:text-gray-300">Immerse yourself in Polish language learning with an interactive study emulator.</p>
