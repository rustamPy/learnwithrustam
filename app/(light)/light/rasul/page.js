...
import RasulFront from './rasul.jpeg'; // Replace with the actual image path
import RasulBack from './rasul2.jpeg'; // Replace with the actual image path
                ...
                {!isFlipped ? (
                    ...
                    >
                        <div className="w-1/2 h-full bg-white p-6 flex flex-col overflow-scroll">
                            ...
                            />
                            <h2 className="text-2xl font-bold mb-4 text-green-600">Proqramlaşdırma Eksperti</h2>
                            <p className="text-gray-700">
                                Rəsul Kərimov, proqramlaşdırma və texnologiya sahəsində geniş bilik və təcrübəyə malikdir.
                                Onun analitik düşüncə tərzi və yaradıcı yanaşmaları onu bu sahədə tanınmış bir mütəxəssis etmişdir.
                    ...
                    >
                        ...
                        <div className="w-1/2 h-full bg-white p-6 flex flex-col overflow-scroll">
                            <img
                                ...
                                className="w-12 h-8 mb-4 self-start"
                            />
                            <h2 className="text-2xl font-bold mb-4 text-green-600">Programming Expert</h2>
                            <p className="text-gray-700">
                                Rasul Karimov is a renowned programming expert with extensive knowledge and experience in the field.
                                His analytical thinking and creative approaches have made him a prominent figure in technology.
                                Click to learn more!
                            </p>
                        </div>
                        <div className="absolute bottom-4 right-4">
