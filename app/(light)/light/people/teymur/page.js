...
const TeymPage = () =>
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg m-10 flex flex-col items-center">
        ...
        <FC frontTitle={"Chess Prodigy"} backTitle={"Şahmat Dahisir"} frontImage={Teymur} backImage={Teymur2} frontText={"Azərbaycanlı istedadlı şahmatçı, strateji dahiliyi və oyunu dərin başa düşməsi ilə tanınır. Onun bir neçə gediş irəlidə düşünə bilmə qabiliyyəti onu güclü rəqib kimi fərqləndirir. Daha ətraflı məlumat üçün klikləyin!"} backText={"Teymur Abdullayev gənc yaşlarından şahmatda üstün bacarıqlarını nümayiş etdirmişdir. Onun kombinasiya düşüncəsi və rəqiblərinin strategiyalarını məharətlə öncədən görməsi, onu yüksək səviyyəli oyunçu kimi tanıdıb. Şahmat masasında olan təmkinli yanaşması və hər bir gedişi incəliklə analiz etməsi, Teymurun zəfərlərini təmin edir. Daha çox məlumat əldə etmək üçün klikləyin!"} />
        ...
        <div className="mt-8">
            <div className="text-gray-700" id="AZ">
                ...
                <p>Teymur Abdullayev və onun nailiyyətləri haqqında daha ətraflı məlumat əldə etmək üçün <Link href="https://www.chess.com/member/killer1996" target="_blank" className="text-blue-500 hover:underline">Chess.com profilini ziyarət edin</Link>.</p>
            </div>
            <br />
            <hr />
            <br />
            <div className="text-gray-900" id="EN">
                ...
                <p>To learn more about Teymur Abdullayev and his achievements, <Link href="https://www.chess.com/member/killer1996" target="_blank" className="text-blue-500 hover:underline">visit his Chess.com profile</Link>.</p>
